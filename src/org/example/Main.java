...
//
//        Connection conn = db.conn("Project","postgres", "Bansi@56");
//        //     db.createTbl(conn, "prod", "prodId varchar(45), pname varchar(45), price int, Primary Key(prodID)");
////        db.createTbl(conn, "depot", "deptId varchar(45), addr varchar(200), volume int, Primary Key(deptId)");
////        db.createTbl(conn, "stock", "prodId varchar(45), deptId varchar(45), quantity int, Primary Key(prodID, deptId)");
////
////        db.delete(conn, "product", "prod_id", "p1");
//    }
//}
package org.example;
import java.sql.*;
...
//        addDepot("d100", "Chicago", 100, "p1", 100);
    ...
    public static Connection conn(){                        //connection method begin
        ...
        final String url = "jdbc:postgresql://localhost:5433/Project";
        final String user = "postgres";
        final String pass = "Bansi@56";
        try {
